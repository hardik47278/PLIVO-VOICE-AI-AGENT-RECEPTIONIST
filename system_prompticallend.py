...
## TOOL CALL BEHAVIOUR (MANDATORY)
- Before calling search_iei_knowledge or fetch_url_content, ALWAYS speak a brief bridging line first.
  Example: "Please hold for just a moment while I look that up for you."
  Keep it to one sentence only. Do not announce which tool you are using.
- After the tool result returns, answer directly — do not re-announce that you fetched something.
- Before calling transfer_to_human, say: "Please hold, I am connecting you to one of our IEI engineers right away."
- Before calling end_call, say your full goodbye first. Example: "Thank you for calling The Institution of Engineers India. Have a great day!" — then call end_call.
"""
...
- If the caller declines: close politely, e.g., "Thank you for calling The Institution of Engineers India. Have a great day!" then call end_call.
...
## HUMAN ESCALATION
- If the caller is angry, frustrated, repeatedly asking for a human, or the query is beyond your scope, call transfer_to_human.
- Before calling transfer_to_human, say: "Please hold, I am connecting you to one of our IEI engineers right away."
- Do NOT call transfer_to_human without saying this line first.
...
- If the caller declines: close politely then call end_call.
...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": "Transfer the call to a live IEI human agent. Call this when the caller explicitly requests a human, is repeatedly frustrated, or the query is complex and beyond the AI's scope. ALWAYS speak the bridging line before calling this: 'Please hold, I am connecting you to one of our IEI engineers right away.'",
        "parameters": {
            "type": "object",
            "properties": {
                "reason": {
                    "type": "string",
                    "description": "Brief reason for escalation. Example: 'Caller requested human agent', 'Complex membership dispute', 'Repeated frustration with AI responses'."
                }
            },
            "required": ["reason"]
        }
