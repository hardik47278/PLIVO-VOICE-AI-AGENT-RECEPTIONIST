        ...
        try:
            async for message in plivo_ws.iter_text():
                ...
                if event == "media":
                    ...
                    # ── Silero VAD: ML-based speech detection (non-blocking) ──
                    ...
                    if speech_detected:
                        ...
                        if not speech_active and speech_frame_count >= FRAMES_REQUIRED and speech_duration >= 100:
                            ...
                            if now_ms - last_interrupt_at >= INTERRUPT_COOLDOWN:
                                # ── Echo gate: suppress if AI was speaking recently ──
                ...
                async for response in session.receive():
                        ...
                        if sc.model_turn:
                            for part in sc.model_turn.parts:
                                if part.inline_data and part.inline_data.data:
                                    ...
                                    try:
                                        # ── Track when AI is speaking for echo gate ──
                    ...
                    if response.tool_call:
                        ...
                        for fc in response.tool_call.function_calls:
                            ...
                            # ── Track name/company for caller memory ──
